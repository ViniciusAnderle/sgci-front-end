        ...
        <q-form greedy ref="formPessoa" class="bg">
            ...
            <div class="main-container">
                ...
                <div class="q-pa-md" style="margin-top: -30px">
                    <h4 style="margin-bottom: 10px" class="subTitulo">Dados Básicos</h4>
                    <div class="row q-col-gutter-lg">
                        ...
                        <div class="col-4">
                            ...
                            <span class="valorVisualizar">{{ formatarPessoa(pessoa?.tipo) }}</span>
                        </div>
                        <div class="col-4">
                            <span class="tituloVisualizar">Estado Civíl: </span>
                            <span class="valorVisualizar">{{
                                formatarEstadoCivil(pessoa?.estadoCivil)
                            }}</span>
                        </div>
                    </div>
                </div>
